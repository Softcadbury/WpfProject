...
namespace DataAccess.ServicePatient {
    ...
    public partial class Patient : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private DataAccess.ServicePatient.Observation[] ObservationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public DataAccess.ServicePatient.Observation[] Observations {
            get {
    ...
    public interface IServicePatient {
        ...
        DataAccess.ServicePatient.Patient[] GetListPatient();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetListPatient", ReplyAction="http://tempuri.org/IServicePatient/GetListPatientResponse")]
        System.Threading.Tasks.Task<DataAccess.ServicePatient.Patient[]> GetListPatientAsync();
        ...
        DataAccess.ServicePatient.Patient GetPatient(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetPatient", ReplyAction="http://tempuri.org/IServicePatient/GetPatientResponse")]
        System.Threading.Tasks.Task<DataAccess.ServicePatient.Patient> GetPatientAsync(int id);
        ...
        bool AddPatient(DataAccess.ServicePatient.Patient user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/AddPatient", ReplyAction="http://tempuri.org/IServicePatient/AddPatientResponse")]
        System.Threading.Tasks.Task<bool> AddPatientAsync(DataAccess.ServicePatient.Patient user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicePatientChannel : DataAccess.ServicePatient.IServicePatient, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicePatientClient : System.ServiceModel.ClientBase<DataAccess.ServicePatient.IServicePatient>, DataAccess.ServicePatient.IServicePatient {
        ...
        public DataAccess.ServicePatient.Patient[] GetListPatient() {
            return base.Channel.GetListPatient();
        }
        
        public System.Threading.Tasks.Task<DataAccess.ServicePatient.Patient[]> GetListPatientAsync() {
            return base.Channel.GetListPatientAsync();
        }
        
        public DataAccess.ServicePatient.Patient GetPatient(int id) {
            return base.Channel.GetPatient(id);
        }
        
        public System.Threading.Tasks.Task<DataAccess.ServicePatient.Patient> GetPatientAsync(int id) {
            return base.Channel.GetPatientAsync(id);
        }
        
        public bool AddPatient(DataAccess.ServicePatient.Patient user) {
            return base.Channel.AddPatient(user);
        }
        
        public System.Threading.Tasks.Task<bool> AddPatientAsync(DataAccess.ServicePatient.Patient user) {
